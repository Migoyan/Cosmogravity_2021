...
var canvasToImage = canvasToImage || (function(view) {
	...
	var canvasToImage = function(canvasId, options, type) {
		...
		switch(type) {
            //au lieu d'utiliser imageCanvas on utilise canvasId directement
			...
			case 'jpg': downloadAsJPG(canvasId, name, quality); break;
			case 'png': downloadAsPNG(canvasId, name, quality); break;
			default: downloadAsPNG(canvasId, name, quality);
		}
	}
